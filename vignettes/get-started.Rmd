...
logical, `Date`, `POSIXct`/`POSIXt`, and `hms`/`difftime` columns. Non-finite numeric values such
...
example. It accepts CSV or RDS files and displays the uploaded data frame in a
`shinydataviewer` card:
